        ...
        <ul className="flex flex-col gap-4 w-full pt-8 list-disc drop-shadow font-light tracking-wide pb-4">
          ...
          <li>
            <p>
              ...
              <span className="font-medium">existentes</span> e todos os acentos
              e cedilhas serão{' '}
              <span className="font-medium">desconsiderados.</span>
            </p>
          </li>
          <li className="pb-6">
            <p>
              Se a letra for destacada da cor{' '}
              <span className="font-medium text-amber-300">amarela</span> ela
              está na palavra mas na{' '}
          ...
          <li className="pb-6">
            <p>
              Se a letra for destacada da cor{' '}
              <span className="font-medium text-emerald-300">verde</span> ela
              está na palavra e na{' '}
